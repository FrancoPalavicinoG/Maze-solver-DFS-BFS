...
namespace maze {
	...
	public:
		...
		eda::LinkedList solve_pila(int f1, int c1, int f2, int c2);
		eda::LinkedList solve_cola(int f1, int c1, int f2, int c2);
		eda::LinkedList solve_pila();
		eda::LinkedList solve_cola();
	};
}